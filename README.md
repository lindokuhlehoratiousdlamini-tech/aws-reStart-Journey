...
From having no formal IT experience to confidently using AWS services, this journey has been one of self-discovery, patience, and constant learning. Each module in AWS re/Start gave me the confidence to believe that tech is for everyone.

## ✨ Vision
I hope to one day:
- Attend and speak at tech events
- Mentor others new to tech
- Build or contribute to solutions that help communities using cloud and AI
- Continue learning in cloud, AI, and DevOps
